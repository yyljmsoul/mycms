...
Route::group([
    ...
    Route::group(['prefix' => 'cms'], function () {
        ...
        Route::post('/modify', 'ArticleController@modify');
		...
		Route::get('/article_group', 'ArticleGroupController@index')->name('cms.article_group');
        Route::get('/article_group/create', 'ArticleGroupController@create')->name('cms.article_group.create');
        Route::post('/article_group/create', 'ArticleGroupController@store');
        Route::get('/article_group/edit', 'ArticleGroupController@edit')->name('cms.article_group.edit');
        Route::post('/article_group/edit', 'ArticleGroupController@update');
        Route::post('/article_group/destroy', 'ArticleGroupController@destroy');
        Route::get('/article_group/json', 'ArticleGroupController@json')->name('cms.article_group.json');
