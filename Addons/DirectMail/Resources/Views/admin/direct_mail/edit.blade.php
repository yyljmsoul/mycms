        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="access_key" class="form-control" lay-verify="required"
                       lay-reqtext="请输入AccessKey" placeholder="请输入AccessKey" value="{{$data->access_key}}">
                <tip>填写AccessKey。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="account_name" class="form-control" lay-verify="required" lay-reqtext="请输入发信地址"
                       placeholder="请输入发信地址" value="{{$data->account_name}}">
                <tip>填写发信地址。</tip>
            </div>
        </div>
            ...
            <div class="col-sm-10">
                <div class="form-check col-md-2">
                    <input type="radio" class="form-check-input" id="is_default1"
                           name="is_default" @if($data->is_default == 1) checked @endif
                           value="1">
                ...
                <div class="form-check col-md-2">
                    <input type="radio" class="form-check-input" id="is_default0"
                           name="is_default" @if($data->is_default == 0) checked @endif
                           value="0">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="region" class="form-control" lay-verify="required" lay-reqtext="请输入地域"
                       placeholder="请输入地域" value="{{$data->region}}">
                <tip>填写地域。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="alias" class="form-control" lay-verify="required" lay-reqtext="请输入发件别名"
                       placeholder="请输入发件别名" value="{{$data->alias}}">
                <tip>填写发件别名。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="remark" class="form-control"
                          placeholder="请输入备注">{{$data->remark}}</textarea>
                <tip>填写备注。</tip>
            </div>
        </div>
