        ...
        <div class="tab-content p-3 text-muted">
            ...
            <div class="tab-pane active" id="base" role="tabpanel">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="sort" class="form-control" placeholder="请输入排序" value="0">
                        <tip>填写排序。</tip>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="style_css" class="form-control" value="">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <label class="col-sm-3 col-form-label">样式类名</label>
                                <div class="col-sm-9">
                                    <input type="text" name="style_class" class="form-control" value="">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <label class="col-sm-3 col-form-label">样式ID</label>
                                <div class="col-sm-9">
                                    <input type="text" name="style_id" class="form-control" value="">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <label class="col-sm-3 col-form-label">Rel属性</label>
                                <div class="col-sm-9">
                                    <input type="text" name="rel" class="form-control" value="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @foreach(system_lang() as $abb => $lang)
                <div class="tab-pane" id="lang-{{$abb}}" role="tabpanel">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label text-end-cms">URL</label>
                        <div class="col-sm-10">
                            <input type="text" name="lang[{{$abb}}][url]" class="form-control"
                                   placeholder="请输入URL" value="">
                            <tip>填写URL。</tip>
                        </div>
                    </div>
