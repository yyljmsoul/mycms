...
namespace Addons\Qiniu\Expand\Sms;
...
class Sms
{
    ...
    {
        $query = array();
        setWithoutEmpty($query, 'job_id', $job_id);
        setWithoutEmpty($query, 'message_id', $message_id);
        setWithoutEmpty($query, 'mobile', $mobile);
        setWithoutEmpty($query, 'status', $status);
        setWithoutEmpty($query, 'template_id', $template_id);
        setWithoutEmpty($query, 'type', $type);
        setWithoutEmpty($query, 'start', $start);
        setWithoutEmpty($query, 'end', $end);
        setWithoutEmpty($query, 'page', $page);
        setWithoutEmpty($query, 'page_size', $page_size);
