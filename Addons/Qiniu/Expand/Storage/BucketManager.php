...
namespace Addons\Qiniu\Expand\Storage;
...
final class BucketManager
{
    ...
    )
    {
        ...
        setWithoutEmpty($query, 'limit', $limit);
        setWithoutEmpty($query, 'delimiter', $delimiter);
        setWithoutEmpty($query, 'skipconfirm', $skipconfirm);
    ...
    )
    {
        ...
        setWithoutEmpty($params, 'host', $host);
        setWithoutEmpty($params, 'key', $key);
        setWithoutEmpty($params, 'md5', $md5);
        setWithoutEmpty($params, 'etag', $etag);
        setWithoutEmpty($params, 'callbackurl', $callbackurl);
        setWithoutEmpty($params, 'callbackbody', $callbackbody);
        setWithoutEmpty($params, 'callbackbodytype', $callbackbodytype);
        setWithoutEmpty($params, 'callbackhost', $callbackhost);
        setWithoutEmpty($params, 'file_type', $file_type);
        setWithoutEmpty($params, 'ignore_same_key', $ignore_same_key);
    ...
    public static function buildBatchRestoreAr($bucket, $key_restore_days_pairs)
    {
        ...
        foreach ($key_restore_days_pairs as $key => $restore_days) {
            array_push($data, '/restoreAr/' . entry($bucket, $key) . '/freezeAfterDays/' . $restore_days);
        }
        return $data;
    }
