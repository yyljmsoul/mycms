...
namespace Addons\Qiniu\Expand\Processing;
...
final class ImageUrlBuilder
{
    ...
    )
    {
        ...
        $waterStr = 'watermark/1/image/' . \Expand\base64_urlSafeEncode($image) . '/';
    ...
    )
    {
        ...
        $waterStr = 'watermark/2/text/'
            . \Expand\base64_urlSafeEncode($text) . '/font/'
            . \Expand\base64_urlSafeEncode($font) . '/';
        ...
        if (!is_null($fontColor)
            ...
            $waterStr .= 'fill/' . \Expand\base64_urlSafeEncode($fontColor) . '/';
        }
