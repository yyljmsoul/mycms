...
use Addons\Oss\Expand\Core\MimeTypes;
use Addons\Oss\Expand\Core\OssException;
use Addons\Oss\Expand\Core\OssUtil;
use Addons\Oss\Expand\Http\RequestCore;
use Addons\Oss\Expand\Http\RequestCore_Exception;
use Addons\Oss\Expand\Http\ResponseCore;
use Addons\Oss\Expand\Model\BucketListInfo;
use Addons\Oss\Expand\Model\BucketStat;
use Addons\Oss\Expand\Model\CnameConfig;
use Addons\Oss\Expand\Model\CorsConfig;
use Addons\Oss\Expand\Model\ExtendWormConfig;
use Addons\Oss\Expand\Model\InitiateWormConfig;
use Addons\Oss\Expand\Model\LifecycleConfig;
use Addons\Oss\Expand\Model\ListMultipartUploadInfo;
use Addons\Oss\Expand\Model\ListPartsInfo;
use Addons\Oss\Expand\Model\LiveChannelConfig;
use Addons\Oss\Expand\Model\LiveChannelInfo;
use Addons\Oss\Expand\Model\LiveChannelListInfo;
use Addons\Oss\Expand\Model\LoggingConfig;
use Addons\Oss\Expand\Model\ObjectListInfo;
use Addons\Oss\Expand\Model\RefererConfig;
use Addons\Oss\Expand\Model\RequestPaymentConfig;
use Addons\Oss\Expand\Model\ServerSideEncryptionConfig;
use Addons\Oss\Expand\Model\StorageCapacityConfig;
use Addons\Oss\Expand\Model\Tag;
use Addons\Oss\Expand\Model\TaggingConfig;
use Addons\Oss\Expand\Model\VersioningConfig;
use Addons\Oss\Expand\Model\WebsiteConfig;
use Addons\Oss\Expand\Result\AclResult;
use Addons\Oss\Expand\Result\AppendResult;
use Addons\Oss\Expand\Result\BodyResult;
use Addons\Oss\Expand\Result\CallbackResult;
use Addons\Oss\Expand\Result\CopyObjectResult;
use Addons\Oss\Expand\Result\DeleteObjectsResult;
use Addons\Oss\Expand\Result\DeleteObjectVersionsResult;
use Addons\Oss\Expand\Result\ExistResult;
use Addons\Oss\Expand\Result\GetBucketEncryptionResult;
use Addons\Oss\Expand\Result\GetBucketInfoResult;
use Addons\Oss\Expand\Result\GetBucketRequestPaymentResult;
use Addons\Oss\Expand\Result\GetBucketStatResult;
use Addons\Oss\Expand\Result\GetBucketTagsResult;
use Addons\Oss\Expand\Result\GetBucketVersioningResult;
use Addons\Oss\Expand\Result\GetBucketWormResult;
use Addons\Oss\Expand\Result\GetCnameResult;
use Addons\Oss\Expand\Result\GetCorsResult;
use Addons\Oss\Expand\Result\GetLifecycleResult;
use Addons\Oss\Expand\Result\GetLiveChannelHistoryResult;
use Addons\Oss\Expand\Result\GetLiveChannelInfoResult;
use Addons\Oss\Expand\Result\GetLiveChannelStatusResult;
use Addons\Oss\Expand\Result\GetLocationResult;
use Addons\Oss\Expand\Result\GetLoggingResult;
use Addons\Oss\Expand\Result\GetRefererResult;
use Addons\Oss\Expand\Result\GetStorageCapacityResult;
use Addons\Oss\Expand\Result\GetWebsiteResult;
use Addons\Oss\Expand\Result\HeaderResult;
use Addons\Oss\Expand\Result\InitiateBucketWormResult;
use Addons\Oss\Expand\Result\InitiateMultipartUploadResult;
use Addons\Oss\Expand\Result\ListBucketsResult;
use Addons\Oss\Expand\Result\ListLiveChannelResult;
use Addons\Oss\Expand\Result\ListMultipartUploadResult;
use Addons\Oss\Expand\Result\ListObjectsResult;
use Addons\Oss\Expand\Result\ListObjectVersionsResult;
use Addons\Oss\Expand\Result\ListPartsResult;
use Addons\Oss\Expand\Result\PutLiveChannelResult;
use Addons\Oss\Expand\Result\PutSetDeleteResult;
use Addons\Oss\Expand\Result\SymlinkResult;
use Addons\Oss\Expand\Result\UploadPartResult;
...
class OssClient
{
    ...
    private function auth($options)
    {
        ...
        //Creates the request
        $request = new RequestCore($requestUrl, $this->paramProxy);
