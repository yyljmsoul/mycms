        ...
        <div class="container">
            <div class="counter-wpr counter-round grid-4 wow fadeInLeft">
                <div class="fun-fact">
                    ...
                    <div class="fun-desc">
                        <p class="timer" data-count="+" data-to="5000" data-speed="3000">5000</p>
                ...
                <div class="fun-fact fun-active">
                    ...
                    <div class="fun-desc">
                        <p class="timer" data-count="+" data-to="1500" data-speed="3000">1500</p>
                ...
                <div class="fun-fact">
                    ...
                    <div class="fun-desc">
                        <p class="timer" data-count="+" data-to="130" data-speed="3000">130</p>
                ...
                <div class="fun-fact">
                    ...
                    <div class="fun-desc">
                        <p class="timer" data-count="+" data-to="600" data-speed="3000">600</p>
