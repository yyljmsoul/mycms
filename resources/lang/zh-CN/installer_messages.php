...
return [
    ...
    'welcome' => [
        'templateTitle' => '欢迎使用',
        'title'   => '欢迎来到 MyCms 安装程序',
        'message' => '欢迎来到安装向导. 本程序由东莞市一码网络科技有限公司开发并拥有版权，请在授权范围内使用程序，请勿将本程序进行二次销售。<br><br>如您在使用过程中存在疑问，请加入QQ群：【887522124】与其他小伙伴交流。.',
        'next'    => '检查系统环境',
    ],
