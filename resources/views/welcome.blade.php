...
<head>
    ...
    <meta name="description"
          content="MyCms是一款基于Laravel8+layuimini开发的模块化后台管理系统。MyCms基于Apache2.0开源协议发布，免费且不限制商业使用，欢迎持续关注我们。">
...
<div id='app'>
    ...
    <header>
        ...
        <div class="right">
            ...
            <div class="navbar">
                ...
                <a class="navbar-item" href="/admin/login" target="_blank">演示</a>
                <a class="navbar-item"
                   href="https://qm.qq.com/cgi-bin/qm/qr?k=y3Q3pCWJdIRtCzdLMGdqMv3Jx04bib8D&jump_from=webapi"
                   target="_blank">QQ群</a>
            </div>
        </div>
    </header>
    ...
    <div class="home-main">
        <div class="title">
            ...
            <p class="operation">
                ...
                <a class="gitee button-grya" target="_blank" href="https://gitee.com/qq386654667/mycms"><i
                        class="icon-gitee"></i>Gitee</a>
            </p>
        </div>
        <!-- 框架特性-->
        <div class="introduction">
            ...
            <div class="bottom">
                <div class="item">
                    ...
                    <p class="item-desc">
                        使用Laravel中间件实现更智能的RBAC权限管理，自动读取更新，无需手动插入节点，告别手工插入时代</p>
                </div>
                <div class="item">
                    <p class="item-title"><span>模块化开发</span></p>
                    <p class="item-desc">
                        万丈高楼平地起，打下扎实的基础，采用Laravel-module实现模块化，降低耦合度，分工更明确，为做大做强创造无限可能</p>
                </div>
                <div class="item">
                    <p class="item-title"><span>JS整合封装</span></p>
                    <p class="item-desc">
                        后台采用Layuimini进行开发，对表格、表单进行封装，统一样式，统一交互，开发更快捷，使用更舒服</p>
                </div>
                <div class="item">
                    <p class="item-title"><span>响应式开发</span></p>
                    <p class="item-desc">
                        后台页面基于Layui开发，手机、平板、PC均已自动适配，无需担心兼容性问题，专注业务逻辑代码开发</p>
                </div>
                <div class="item">
                    <p class="item-title"><span>更快的PHP7</span></p>
                    <p class="item-desc">
                        系统基于PHP7.3+进行开发，相比PHP5有倍级的性能提升，更完善的类型声明，PHP是世界上最好的开发语言。</p>
                </div>
                <div class="item">
                    <p class="item-title"><span>高拓展性</span></p>
                    <p class="item-desc">
                        基于Laravel8进行后台程序开发，让您从杂乱的代码解脱出来，高质量的文档，丰富的拓展包，开发更高效，代码更优雅</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <p class="beian-number">Copyright © <a href="https://www.mycms.net.cn/">MyCms</a> 版权所有，并保留所有权利
            </p>
        </div>
    </footer>
@endsection
