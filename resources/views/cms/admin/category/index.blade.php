...
@section('extend-javascript')
    <script>
        myAdmin.table({
            ...
            index_url: '/admin/cms/category',
            add_url: '/admin/cms/category/create',
            edit_url: '/admin/cms/category/edit',
            delete_url: '/admin/cms/category/destroy',
        }, [
            {type: "checkbox"},
            {field: 'id', width: 80, title: '序号'},
            {field: 'name', minWidth: 80, title: '名称', search: true},
            {
                field: 'parent.name', minWidth: 80, title: '父级'
            },
