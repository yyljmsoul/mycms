...
@section('page-content-wrapper')
    <form id="app-form">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="name"  class="form-control" placeholder="请输入项目名称" value="">
				<tip>填写项目名称。</tip>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="ident"  class="form-control" placeholder="请输入项目key" value="">
				<tip>填写项目key。</tip>
			</div>
		</div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea type="text" name="description"  class="form-control" placeholder="请输入项目描述"></textarea>
                <tip>填写项目描述。</tip>
            </div>
        </div>
