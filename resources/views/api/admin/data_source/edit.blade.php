...
@section('page-content-wrapper')
    <form id="app-form">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="table_name" readonly  class="form-control" placeholder="请输入数据表名称" value="{{$tableName}}">
                <tip>填写数据表名称。</tip>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select" name="field_type[]">
                                        <option value="int" {{$item['type'] == 'integer' ? 'selected' : ''}}>整数</option>
                                        <option value="bigint" {{$item['type'] == 'bigInteger' ? 'selected' : ''}}>大整数</option>
                                        <option value="decimal" {{$item['type'] == 'decimal' ? 'selected' : ''}}>浮点数</option>
                                        <option value="timestamp" {{$item['type'] == 'timestamp' ? 'selected' : ''}}>日期时分秒</option>
                                        <option value="varchar" {{$item['type'] == 'string' ? 'selected' : ''}}>字符串</option>
                                        <option value="text" {{$item['type'] == 'text' ? 'selected' : ''}}>文本</option>
                                        <option value="longtext" {{$item['type'] == 'longText' ? 'selected' : ''}}>长文本</option>
                                    </select>
                                </td>
