        ...
        <div class="tab-content p-3 text-muted">
            <div class="tab-pane active" id="base" role="tabpanel">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="page_desc" class="form-control"></textarea>
                    </div>
                </div>
            ...
            @foreach(system_tap_lang() as $abb => $lang)
                <div class="tab-pane" id="lang-{{$abb}}" role="tabpanel">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label text-end-cms">页面描述</label>
                        <div class="col-sm-10">
                            <textarea name="lang[{{$abb}}][page_desc]" class="form-control"></textarea>
                        </div>
                    </div>
