...
@section('page-content-wrapper')
    <form id="app-form">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="cfg_key" class="form-control" placeholder="请输入配置标识"
                       value="{{$data->cfg_key ?? ""}}">
                <tip>填写配置标识。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="cfg_val" class="form-control">{{$data->cfg_val ?? ""}}</textarea>
                <tip>填写配置值。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="cfg_group" class="form-control" placeholder="请输入配置分组"
                       value="{{$data->cfg_group ?? ""}}">
                <tip>填写配置分组。</tip>
            </div>
        </div>
