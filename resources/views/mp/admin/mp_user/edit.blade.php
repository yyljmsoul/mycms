...
@section('page-content-wrapper')
    <form id="app-form">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="openid"  class="form-control" placeholder="请输入openid" value="{{$data->openid}}">
				<tip>填写openid。</tip>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="unionid"  class="form-control" placeholder="请输入unionid" value="{{$data->unionid}}">
				<tip>填写unionid。</tip>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="tagid_list"  class="form-control" placeholder="请输入标签" value="{{$data->tagid_list}}">
				<tip>填写标签。</tip>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="subscribe_scene"  class="form-control" placeholder="请输入关注来源" value="{{$data->subscribe_scene}}">
				<tip>填写关注来源。</tip>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="qr_scene"  class="form-control" placeholder="请输入二维码" value="{{$data->qr_scene}}">
				<tip>填写二维码。</tip>
			</div>
		</div>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" name="subscribe_time"  class="form-control" placeholder="请输入关注时间" value="{{$data->subscribe_time}}">
				<tip>填写关注时间。</tip>
			</div>
		</div>
