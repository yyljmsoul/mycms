...
@section('page-content-wrapper')
    <form id="app-form">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="name" class="form-control" placeholder="请输入任务名称" value="">
                <tip>填写任务名称。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="article_id" class="form-control" placeholder="请输入文章ID" value="">
                <tip>填写文章ID。</tip>
            </div>
        </div>
