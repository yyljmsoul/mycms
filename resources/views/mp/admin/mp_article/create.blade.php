...
@section('page-content-wrapper')
    <form id="app-form">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="author" class="form-control" placeholder="请输入作者" value="">
                <tip>填写作者。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="digest" class="form-control" placeholder="请输入摘要"></textarea>
                <tip>填写摘要。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="content" id="content" class="editor" placeholder="请输入内容"></textarea>
                <tip>填写内容。</tip>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="content_source_url" class="form-control" placeholder="请输入原文地址" value="">
                <tip>填写原文地址。</tip>
            </div>
        </div>
