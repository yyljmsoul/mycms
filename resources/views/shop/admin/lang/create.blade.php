    ...
    <form id="app-form">
        ...
        <div class="tab-content p-3 text-muted">
            <div class="tab-pane active" id="base" role="tabpanel">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-end-cms">语言版本</label>
                    <div class="col-sm-10">
                        <select class="form-select" name="abb" id="abb">
                            <option value="">选择商品语言</option>
                            @foreach(system_tap_lang() as $key => $item)
                                @if(!in_array($key,$notExistLang))
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10 cms-upload">
                                <input name="lang[goods_albums][0]" type="hidden" class="form-control"
                                       placeholder="请上传图片"
                                       value="">
                                <input type="file" class="form-control" data-name="lang[goods_albums][0]" cms-upload
                                       data-max-size="2" data-upload-exts=".ico,.png,.jpg,.jpeg">
                                <div class="my-1 upload-thumb">
                                </div>
                            </div>
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label text-end-cms">图片</label>
                            <div class="col-sm-10 cms-upload">
                                <input name="lang[mobile_images][0]" type="hidden" class="form-control"
                                       placeholder="请上传详情图片"
                                       value="">
                                <input type="file" class="form-control" data-name="lang[mobile_images][0]" cms-upload
                                       data-max-size="2" data-upload-exts=".ico,.png,.jpg,.jpeg">
                                <div class="my-1 upload-thumb">
                                </div>
                            </div>
