...
@section('page-content-wrapper')
    ...
    <script>
        specArray = {!! json_encode($specArray, JSON_UNESCAPED_UNICODE) !!};
    </script>
            ...
            <div class="tab-pane active" id="base" role="tabpanel">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 cms-upload">
                        ...
                        <input type="file" class="form-control" data-name="goods_image" cms-upload data-max-size="2"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="shop_price" class="form-control"
                               placeholder="请输入售价" value="{{$goods->shop_price}}">
                        <tip>填写售价。</tip>
                    </div>
                </div>
                        ...
                        @foreach($attributes as $item)
                            <div class="form-check col-md-2">
                                ...
                                <input type="checkbox" class="form-check-input"
                                       ...
                                       value="1" @if($goods->{$item['ident']} == 1) checked
                                    @endif>
                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 cms-upload">
                                    <input name="goods_albums[{{$key}}]" type="hidden" class="form-control"
                                           placeholder="请上传图片"
                                           value="{{$albums->goods_image}}">
                                    <input type="file" class="form-control" data-name="goods_albums[{{$key}}]"
                        ...
                        <div class="layui-card-body">
                            <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="col-sm-3">
                                            <input type="text" name="spec[{{$spec['id']}}]"
                                                   class="form-control spec-item" data-num="{{$spec['id']}}"
                                    ...
                                    <div class="col-sm-10 specVal">
                                        <div class="row">
                                            @foreach($spec['values'] ?: [] as $value)
                                                <div class="col-sm-3">
                                                    <input type="text" name="specVal[{{$spec['id']}}][{{$value['id']}}]"
                                                           class="form-control"
                                                           readonly data-id="{{$spec['id']}}" placeholder="规格值"
                                                           value="{{$value['value']}}">
                                                </div>
                                            @endforeach
                                            <div class="col-sm-3">
                                                <input type="text" name="specVal[{{$spec['id']}}][]"
                                                       class="form-control"
                                                       data-id="{{$spec['id']}}" placeholder="规格值"
                                                       value="">
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="button"
                                                class="add-spec-val-btn btn btn-light waves-effect">
                                            新增规格值
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label text-end-cms">图片</label>
                                <div class="col-sm-10 cms-upload">
                                    <input name="mobile_images[{{$key}}]" type="hidden" class="form-control"
                                           placeholder="请上传详情图片"
                                           value="{{$image->path}}">
                                    <input type="file" class="form-control" data-name="mobile_images[{{$key}}]"
                                           cms-upload
