...
(function (h) {
    ...
    function vb(a) {
        ...
        f.p || (b.id = a.sTableId + "_paginate", a.aoDrawCallback.push({
            fn: function (a) {
                if (d) {
                    var b = a._iDisplayStart, i = a._iDisplayLength, h = a.fnRecordsTotal(), m = -1 === i,
                        b = a.oInit.currentPage, i = m ? 1 : Math.ceil(h / i), h = c(b, i), k, m = 0;
    ...
    function ja(a, b) {
        ...
        b <= c
            ? c = Z(0, b)
            : a <= d ? (c = Z(0, c - 2), c.push("ellipsis"), c.push(b - 1)) : (a >= b - 1 - d ? c = Z(b - (c - 2), b)
                : (c = Z(a - d + 2, a + d - 1), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0));
        c.DT_el = "span";
        return c
    }
    ...
    l.models.oSettings = {
        ...
        fnRecordsTotal: function () {
            return y(this) == "ssp" ? this._iRecordsTotal * 1 : this.oInit.pageTotal
        },
